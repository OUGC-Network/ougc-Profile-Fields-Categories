...
$l['ougc_profiecats_admin_forums'] = 'Forums';
$l['ougc_profiecats_admin_forums_desc'] = 'Select the forums this category will be shown in.';
$l['ougc_profiecats_admin_required'] = 'Required';
$l['ougc_profiecats_admin_required_desc'] = 'Select whether this category should be required to participate in the above forums.';
$l['ougc_profiecats_admin_disporder'] = 'Display Order';
$l['ougc_profiecats_admin_disporder_desc'] = 'Enter the display order of this category.';
$l['ougc_profiecats_admin_tab_add'] = 'Add';
$l['ougc_profiecats_admin_tab_add_desc'] = 'Add custom profile fields categories.';
$l['ougc_profiecats_admin_tab_edit'] = 'Edit';
